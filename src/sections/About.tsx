...
export const About = () => {
  return (
    <section className="px-[14px] pt-[45px] pb-[45px] forDesktop:px-[102px] forDesktop:pt-[70px] forDesktop:pb-[80px] forDesktopHD:pt-[87px] forDesktopHD:pb-[70px] fullHD:px-[360px]">
      <Title>Що нового</Title>
      <div className="mt-[40px] flex flex-col items-center justify-center gap-y-[40px] forDesktopHD:flex-row forDesktopHD:mt-[50px] forDesktopHD:gap-x-[190px] fullHD:justify-between">
