...
export const Product = () => {
  return (
    <section className='px-[14px] bg-secondBgColour pt-[40px] pb-[30px] forDesktop:pt-[60px] forDesktop:pb-[40px]'>
    <Title className='text-[32px] text-mainColour mb-[20px] forDesktop:text-[44px] forDesktop:mb-[30px]'>IPHONE 14 PRO</Title>
